"""
Train a simple MLP on synthetic data (PyTorch baseline).

This is the reference implementation that GT should match.
"""
...
def main():
    print("=" * 60)
    print("Training MLP on Synthetic Data (PyTorch)")
    print("=" * 60)
    ...
    with torch.no_grad():
        ...
        accuracy = ((pred > 0.5).float() == y_tensor).float().mean()
